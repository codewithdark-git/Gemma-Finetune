    ...
    with gr.Blocks(title="Gemma Fine-tuning UI") as app:
        ...
        def preprocess_data(file, format_type):
            try:
                ...
                dataset = self.prepare_dataset(file.name, format_type)
        ...
        def start_training(
            ...
            try:
                ...
                import threading
                def train_thread():
                    status = self.train(training_params)
                    return status
        ...
        def update_progress_plot():
            try:
                return self.plot_training_progress()
            except Exception as e:
                return None
        ...
        def run_text_generation(prompt, max_length):
            try:
                ...
                return self.generate_text(prompt, int(max_length))
            except Exception as e:
        ...
        def export_model_fn(format_type):
            try:
                ...
                return self.export_model(format_type)
            except Exception as e:
